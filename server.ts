...
// In-Memory & Disk-Backed Persistence Store for Policies and Audit Logs
...
// Helper to resolve Gemini API Key from process environment
...
async function runOcrPreProcessingStep(
  ...
  try {
    ...
    parts.push({
      text: `[FAST OCR PRE-PROCESSING & CLASSIFICATION TASK]
...
Return JSON matching:
{
  ...
  "language": string
    ...
    const preProcessResponse = await ai.models.generateContent({
    ...
    const jsonText = preProcessResponse.text || "{}";
